...
def decompose(n):
    ...
    print("ma_liste_de_nombre_premiers : ", ma_liste_de_nombre_premiers)
    facteurs = []
    i=0
    while(n >= ma_liste_de_nombre_premiers[i]):
        if(n % ma_liste_de_nombre_premiers[i] == 0):
            n = n / ma_liste_de_nombre_premiers[i]
            facteurs.append(ma_liste_de_nombre_premiers[i])
        else:
            i = i + 1
    return facteurs

print('decompose(100) : ', decompose(100))
